...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "auth.email.verify_body_html": {
        ...
        "ja": '<p>こんにちは、</p><p>Klaraを使い始めるためにメールアドレスを確認してください：</p><p><a href="{link}">メールを確認</a></p><p>心当たりがない場合はこのメッセージを無視してください。</p>',
    ...
    "auth.email.reset_body_html": {
        ...
        "ja": '<p>こんにちは、</p><p>クリックして新しいパスワードを設定してください：</p><p><a href="{link}">パスワードをリセット</a></p><p>リンクは1時間後に期限切れになります。心当たりがない場合は無視してください。</p>',
